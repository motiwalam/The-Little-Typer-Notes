...
\subsubsection{*distributes-over+_right ((right) distributivity of multiplication over addition \((a + b)c = ac + bc\))} \label{code:*distributes-over+_right}
\begin{minted}{scheme}
...
\subsubsection{*distributes-over+_left ((left) distributivity of multiplication over addition \(a(b + c) = ab + ac\))} \label{code:*distributes-over+_left}
\begin{minted}{scheme}
